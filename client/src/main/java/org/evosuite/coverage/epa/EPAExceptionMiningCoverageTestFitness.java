...
public class EPAExceptionMiningCoverageTestFitness extends TestFitnessFunction {
	 ...
	 */
	public EPAExceptionMiningCoverageTestFitness(String targetClass, EPAState fromState, String actionId, EPAState toState)
			throws IllegalArgumentException {
	...
	public String getKey() {
		return "EPAExceptionMiningTransition[" + fromState.getName() + "_" + actionId + "_" + toState.getName() + "]";
	}
	...
	public int compareTo(TestFitnessFunction other) {
		if (other instanceof EPAExceptionMiningCoverageTestFitness) {
			EPAExceptionMiningCoverageTestFitness otherMethodFitness = (EPAExceptionMiningCoverageTestFitness) other;
			if (actionId.equals(otherMethodFitness.actionId)) {
				if (fromState.equals(((EPAExceptionMiningCoverageTestFitness) other).fromState)) {
					return this.toState.getName().compareTo(((EPAExceptionMiningCoverageTestFitness) other).toState.getName());
				} else
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EPAExceptionMiningCoverageTestFitness other = (EPAExceptionMiningCoverageTestFitness) obj;
		if (actionId == null) {
